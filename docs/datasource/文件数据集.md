...
1. 在Datafor导航菜单中，点击”数据连接“，并选择”文件“标签页。
   ...
   <div align="left"><img  width="67%"  src="../../static/img/datafor/datasource/image-20220828140631684.png" alt="image-20220828140631684" />  </div>
...
4. 点击”上传“按钮，上传文件中的数据
   ...
   <div align="left"><img src="../../static/img/datafor/datasource/image-20220828143551808.png" alt="image-20220828143551808"  width="80%" /></div>
