...
**URL格式**：http://<datafor-server>/datafor/plugin/datafor/api/<model>/<report id>?<parameter>&<parameter>
...
http://localhost:28080/datafor/plugin/datafor/api/integrate/L2hvbWUvYWRtaW4vZXhhbXBsZTEuZGF0YWZvcg==?__compact=true&__clean=true&__forceAdjust=true
```
